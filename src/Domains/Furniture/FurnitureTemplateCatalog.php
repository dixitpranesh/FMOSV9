...
final class FurnitureTemplateCatalog
{
    ...
    public static function all(): array
    {
        $commonCarcass = [
            ...
            // Legacy units used 6mm thin backs (max was 12). 18mm is now recommended for stability.
        ...
        return [
            ...
            'KITCHEN_BASE' => [
                ...
                'parameters' => [
                    'width' => ['default' => 600, 'min' => 300, 'max' => 2400, 'unit' => 'mm'],
                    'height' => ['default' => 720, 'min' => 500, 'max' => 1200, 'unit' => 'mm'],
                    'depth' => ['default' => 560, 'min' => 400, 'max' => 700, 'unit' => 'mm'],
                    'carcass_thickness' => ['default' => 18, 'min' => 12, 'max' => 25, 'unit' => 'mm'],
                    'back_thickness' => ['default' => 18, 'min' => 3, 'max' => 25, 'unit' => 'mm', 'recommended' => 18],
                    'back_material_id' => ['type' => 'catalog_board', 'default' => null, 'label' => 'Back panel board'],
                    'shutter_count' => ['default' => 1, 'min' => 0, 'max' => 4, 'unit' => 'pcs'],
            ...
            'KITCHEN_WALL' => [
                ...
                'parameters' => [
                    'width' => ['default' => 600, 'min' => 300, 'max' => 2400, 'unit' => 'mm'],
                    'height' => ['default' => 720, 'min' => 400, 'max' => 1200, 'unit' => 'mm'],
                    'depth' => ['default' => 320, 'min' => 250, 'max' => 450, 'unit' => 'mm'],
                    'carcass_thickness' => ['default' => 18, 'min' => 12, 'max' => 25, 'unit' => 'mm'],
                    'back_thickness' => ['default' => 18, 'min' => 3, 'max' => 25, 'unit' => 'mm', 'recommended' => 18],
                    'back_material_id' => ['type' => 'catalog_board', 'default' => null, 'label' => 'Back panel board'],
                    'shutter_count' => ['default' => 1, 'min' => 0, 'max' => 4, 'unit' => 'pcs'],
            ...
            'KITCHEN_TALL' => [
                ...
                'parameters' => [
                    'width' => ['default' => 600, 'min' => 400, 'max' => 1200, 'unit' => 'mm'],
                    'height' => ['default' => 2100, 'min' => 1500, 'max' => 2700, 'unit' => 'mm'],
                    'depth' => ['default' => 560, 'min' => 400, 'max' => 700, 'unit' => 'mm'],
                    'carcass_thickness' => ['default' => 18, 'min' => 12, 'max' => 25, 'unit' => 'mm'],
                    'back_thickness' => ['default' => 18, 'min' => 3, 'max' => 25, 'unit' => 'mm', 'recommended' => 18],
                    'back_material_id' => ['type' => 'catalog_board', 'default' => null, 'label' => 'Back panel board'],
            ...
            'CHEST_DRAWERS' => [
                ...
                'parameters' => [
                    'width' => ['default' => 900, 'min' => 400, 'max' => 2000, 'unit' => 'mm'],
                    'height' => ['default' => 900, 'min' => 500, 'max' => 1500, 'unit' => 'mm'],
                    'depth' => ['default' => 450, 'min' => 300, 'max' => 700, 'unit' => 'mm'],
                    'carcass_thickness' => ['default' => 18, 'min' => 12, 'max' => 25, 'unit' => 'mm'],
                    'back_thickness' => ['default' => 18, 'min' => 3, 'max' => 25, 'unit' => 'mm', 'recommended' => 18],
                    'back_material_id' => ['type' => 'catalog_board', 'default' => null, 'label' => 'Back panel board'],
            ...
            'BOOKCASE' => [
                ...
                'parameters' => [
                    'width' => ['default' => 900, 'min' => 400, 'max' => 3000, 'unit' => 'mm'],
                    'height' => ['default' => 1800, 'min' => 800, 'max' => 2700, 'unit' => 'mm'],
                    'depth' => ['default' => 350, 'min' => 250, 'max' => 600, 'unit' => 'mm'],
                    'carcass_thickness' => ['default' => 18, 'min' => 12, 'max' => 25, 'unit' => 'mm'],
                    'back_thickness' => ['default' => 18, 'min' => 3, 'max' => 25, 'unit' => 'mm', 'recommended' => 18],
                    'back_material_id' => ['type' => 'catalog_board', 'default' => null, 'label' => 'Back panel board'],
                    'shutter_count' => ['default' => 0, 'min' => 0, 'max' => 4, 'unit' => 'pcs'],
                    'door_type' => ['default' => 'NONE', 'type' => 'enum', 'options' => ['NONE', 'HINGED']],
            ...
            'CROCKERY' => [
                ...
                'parameters' => [
                    'width' => ['default' => 1200, 'min' => 600, 'max' => 3000, 'unit' => 'mm'],
                    'height' => ['default' => 1800, 'min' => 1000, 'max' => 2700, 'unit' => 'mm'],
                    'depth' => ['default' => 400, 'min' => 300, 'max' => 600, 'unit' => 'mm'],
                    'carcass_thickness' => ['default' => 18, 'min' => 12, 'max' => 25, 'unit' => 'mm'],
                    'back_thickness' => ['default' => 18, 'min' => 3, 'max' => 25, 'unit' => 'mm', 'recommended' => 18],
                    'back_material_id' => ['type' => 'catalog_board', 'default' => null, 'label' => 'Back panel board'],
                    'shutter_count' => ['default' => 2, 'min' => 0, 'max' => 4, 'unit' => 'pcs'],
            ...
            'VANITY' => [
                ...
                'parameters' => [
                    'width' => ['default' => 900, 'min' => 400, 'max' => 2000, 'unit' => 'mm'],
                    'height' => ['default' => 750, 'min' => 500, 'max' => 1200, 'unit' => 'mm'],
                    'depth' => ['default' => 450, 'min' => 300, 'max' => 600, 'unit' => 'mm'],
                    'carcass_thickness' => ['default' => 18, 'min' => 12, 'max' => 25, 'unit' => 'mm'],
                    'back_thickness' => ['default' => 18, 'min' => 3, 'max' => 25, 'unit' => 'mm', 'recommended' => 18],
                    'back_material_id' => ['type' => 'catalog_board', 'default' => null, 'label' => 'Back panel board'],
                    'shutter_count' => ['default' => 2, 'min' => 0, 'max' => 4, 'unit' => 'pcs'],
            ...
            'STUDY_TABLE' => [
                ...
                'parameters' => [
                    'width' => ['default' => 1200, 'min' => 800, 'max' => 2400, 'unit' => 'mm'],
                    'height' => ['default' => 750, 'min' => 650, 'max' => 900, 'unit' => 'mm'],
                    'depth' => ['default' => 600, 'min' => 400, 'max' => 800, 'unit' => 'mm'],
                    'carcass_thickness' => ['default' => 18, 'min' => 12, 'max' => 25, 'unit' => 'mm'],
                    'back_thickness' => ['default' => 18, 'min' => 3, 'max' => 25, 'unit' => 'mm', 'recommended' => 18],
                    'back_material_id' => ['type' => 'catalog_board', 'default' => null, 'label' => 'Back panel board'],
                    'shutter_count' => ['default' => 1, 'min' => 0, 'max' => 2, 'unit' => 'pcs'],
